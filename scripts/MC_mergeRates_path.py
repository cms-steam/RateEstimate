...
#        h1 = open(output_name[:-4]+'_L1.tsv', "w")
    ...
    for j in xrange (0,Nlines):
        ...
        if AveWrite:
            ...
            text_rate += str(TotalRateList[j]*File_Factor*lumiSF/float(tmp_group_len))
            text_rate += "\t+/-\t"
        ...
        for i in xrange(0,len(datasetList)):
            if rateList[0][j]==0 or TotalEventsPerDataset[datasetListFromFile[i]] == 0:
                ...
                rate = rateList[2*i+6][j]*rateDataset[datasetListFromFile[i]]/TotalEventsPerDataset[datasetListFromFile[i]]*File_Factor*lumiSF
...
mergeRates(["../../MC_10B/ResultsBatch/ResultsBatch_Events/","../../MC_10B_2/ResultsBatch/ResultsBatch_Events/","../../MC_10A/ResultsBatch/ResultsBatch_Events/","../../MC_10A_2/ResultsBatch/ResultsBatch_Events/","../../MC_12/ResultsBatch/ResultsBatch_Events/"],"../Results/output.tsv",'matrixEvents_',False)
