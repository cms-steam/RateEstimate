                        ...
                        if (groupCheck ): 
                            ...
                            for ii in range(2,len(datasetList)+2):
                                if "TotalEvents" in line[0]:
                                    ...
                                    rateList[ii].append(float(line[ii-1])*lumiSF)
                            tmp_rate=0.0
                            for ii in range(2,len(datasetList)+2):
                        ...
                        if (groupCheck ):
                            ...
                            for ii in range(2,len(datasetList)+2):
                                if "TotalEvents" in line[0]:
                                    ...
                                    rateList[ii][i] += float(line[ii-1])*lumiSF
...
mergeRates("ResultsBatch/","Results/output.group.tsv",'matrixEvents.groups',False)
mergeRates("ResultsBatch/","Results/output.dataset.tsv",'matrixEvents.primaryDataset',False)
