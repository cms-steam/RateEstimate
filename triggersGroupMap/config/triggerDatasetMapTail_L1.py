...
groupList.append('All_L1')
for trigger in L1List:
    if remove_trigger(trigger):continue
    if 'All_L1' in getTriggerString.keys(): getTriggerString['All_L1']+='||'+trigger
    else: getTriggerString['All_L1']=trigger
